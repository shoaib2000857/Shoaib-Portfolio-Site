...
const description =
  "I'm am a computer science enthusiast persuing an online BS in Data Science from Indian Institute of Technology Madras along with a Bachelors in Technology in Computer Science and Technology from Keshav Memorial institution Hyderabad."; // original text preserved
const skillsList = [
  "Web design",
  "Data Analysis",
  "Python programming",
  ...
  return (
    <section id="about" className="section-padding relative">
      ...
      <div className="relative max-w-5xl mx-auto glass p-10 md:p-16 animate-in">
        <h2 className="heading-gradient text-3xl md:text-4xl font-semibold text-center mb-8">
          About Myself
        </h2>
