  ...
  return (
    <section id="education" className="section-padding relative">
      ...
      <div className="relative max-w-4xl mx-auto glass p-10 md:p-16 animate-in">
        <h2 className="heading-gradient text-3xl md:text-4xl font-semibold text-center mb-10">Education</h2>
        <div className="space-y-10">
          ...
          <div>
            <h3 className="text-xl font-semibold">Keshav Memorial Institute Of Technology Hyderabad</h3>
