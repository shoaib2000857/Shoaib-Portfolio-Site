...
export function Hero() {
  return (
    <section id="home" className="relative h-[100dvh] flex items-center justify-center overflow-hidden">
      <Image src={tiger} alt="Bengal tiger in the wild" priority fill unoptimized className="object-cover" />
      ...
      >
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
          <a href="#projects" className="glass px-6 py-3 text-sm font-semibold uppercase tracking-wide hover:scale-[1.02] active:scale-95 transition">View Projects</a>
          <a href="#contact" className="px-6 py-3 text-sm font-semibold uppercase tracking-wide border border-white/40 hover:bg-white/10 rounded-2xl text-white transition">Contact</a>
        </div>
      </motion.div>
    </section>
  )
